...
def main(argv=None):
  ...
  configs['defaults']['env'].setdefault('lite6', {})
  configs['defaults']['env']['lite6'].setdefault('host', '127.0.0.1')
  configs['defaults']['env']['lite6'].setdefault('port', 5555)
  configs['defaults']['env']['lite6'].setdefault('timeout', 30)
  configs['defaults']['env']['lite6'].setdefault('logdir', '')
  configs['defaults']['env']['lite6'].setdefault('video_fps', 30)
  configs['defaults']['env']['lite6'].setdefault('video_w', 640)
  configs['defaults']['env']['lite6'].setdefault('video_h', 480)
  configs['defaults']['env']['lite6'].setdefault('video_seconds', 20)
  ...
  configs['defaults']['env']['lite6'].setdefault('task_variant', 'reach')
  configs['defaults']['env']['lite6'].setdefault('ball_radius', 0.03)
  configs['defaults']['env']['lite6'].setdefault('grasp_dist_thresh', 0.04)
  configs['defaults']['env']['lite6'].setdefault('lift_height_thresh', 0.08)
